...
const doAudioDenoiserApply = createAppAsyncThunk(
    ...
    async (_, { getState, dispatch, rejectWithValue }) => {
        ...
        try {
            ...
            const handle = await applyAudioDenoiser({
                inputStream: localStream,
                doCaptureException: (err, ctx) => {
                    console.error("[audioDenoiser]", err, ctx);
                },
            });
...
const doAudioDenoiserTeardown = createAppAsyncThunk("audioDenoiser/teardown", async (_, { getState, dispatch }) => {
...
export const doAudioDenoiserEnable = createAppAsyncThunk("audioDenoiser/enable", async (_, { dispatch }) => {
