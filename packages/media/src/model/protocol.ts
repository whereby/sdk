...
export const PROTOCOL_RESPONSES = {
    ...
    ROOM_INTEGRATION_STARTED: "room_integration_started",
    ROOM_INTEGRATION_STOPPED: "room_integration_stopped",
    ROOM_INTEGRATION_PROPS_UPDATED: "room_integration_props_updated",
