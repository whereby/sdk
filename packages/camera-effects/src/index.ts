...
const getBackgroundUrl = async (name: keyof typeof assetUrls.backgrounds): Promise<{ default: string }> => {
    if (USE_CDN_ASSETS) {
        ...
        const backgrounds: Record<string, () => Promise<{ default: string }>> = {
            ...
            "clay-720p.jpg": () => import("../assets/backgrounds/clay-720p.jpg"),
            "focus-720p.jpg": () => import("../assets/backgrounds/focus-720p.jpg"),
            "glow-720p.jpg": () => import("../assets/backgrounds/glow-720p.jpg"),
            "haven-720p.jpg": () => import("../assets/backgrounds/haven-720p.jpg"),
            "pulse-720p.jpg": () => import("../assets/backgrounds/pulse-720p.jpg"),
            "studio-720.jpg": () => import("../assets/backgrounds/studio-720p.jpg"),
        ...
        const filenameMap: Record<keyof typeof assetUrls.backgrounds, string> = {
            ...
            clay: "clay-720p.jpg",
            focus: "focus-720p.jpg",
            glow: "glow-720p.jpg",
            haven: "haven-720p.jpg",
            pulse: "pulse-720p.jpg",
            studio: "studio-720.jpg",
            neon: "neon.mp4",
            bubbles: "bubbles.mp4",
        };
