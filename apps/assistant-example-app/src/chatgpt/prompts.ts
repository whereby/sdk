...
export const systemPrompt = {
    ...
    item: {
        ...
        content: [
            {
                type: "input_text",
                text: `You are ChatBot. Respond to what the user said in a creative and helpful way. Keep your responses short and aim to ask a follow-up question. Let the user lead the conversation when possible.`,
            },
        ],
    },
